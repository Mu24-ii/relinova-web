...
export default function LubricationCoursePage() {
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              isArabic ? 'المهندسون الراغبون في التحضير لشهادات التزييت المعتمدة عالمياً مثل (ICML MLA I / MLT I).' : 'Engineers preparing for global lubrication certifications like ICML MLA I / MLT I.'
            ].map((item, index) => (
