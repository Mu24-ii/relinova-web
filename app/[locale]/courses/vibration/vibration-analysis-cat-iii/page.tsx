...
export default function VibrationAnalysisLevel3CoursePage() {
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              isArabic ? 'الحاصلون على اعتمادات Cat II الراغبون في نيل الاعتماد المتقدم ISO Vibration Analyst Category III (من Mobius Institute أو VI Code).' : 'Cat II certificate holders seeking advanced ISO Vibration Analyst Category III certification.'
            ].map((item, index) => (
